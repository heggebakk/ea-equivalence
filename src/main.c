...
int main(void) {
    char *fileF;
    fileF = "/home/marie/Master-thesis/ea-equivalence/src/resources/TT_library/dim6/q_6_1.tt";
    truthTable functionF = parseTruthTable(fileF);
    partitions partitionF = partitionFunction(&functionF, 4, 0);
    printf("\n");
    char *fileG;
    fileG = "/home/marie/Master-thesis/ea-equivalence/src/resources/TT_library/dim6/q_6_2.tt";
